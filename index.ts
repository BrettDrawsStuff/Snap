...
function mainPage(base: string, listing: OnChainListing | null) {
  ...
  const elements: Record<string, UIElement<string, Record<string, unknown>>> = {
  ...
  return { version: "1.0" as const, theme: { accent: "teal" as const }, ui: { root: "page", elements } } as any;
}

function bidsPage(base: string, bids: OnChainBid[], listing: OnChainListing | null) {
